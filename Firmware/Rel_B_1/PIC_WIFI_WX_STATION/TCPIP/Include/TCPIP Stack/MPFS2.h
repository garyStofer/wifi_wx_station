...
*/
			...
			#define MPFS_WRITE_PAGE_SIZE		(256u)	// Defines the size of a page in EEPROM
                #elif defined(USE_EEPROM_25LC512)
			#define MPFS_WRITE_PAGE_SIZE		(128u)	// Defines the size of a page in EEPROM
                #elif defined(USE_EEPROM_25LC256)
                        #define MPFS_WRITE_PAGE_SIZE		(64u)	// Defines the size of a page in EEPROM
                #else
                    #error No EEprom device type defined
		#endif
	#endif
